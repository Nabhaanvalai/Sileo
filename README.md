...
<p align="center">
  <i>Thank you to <a href="https://github.com/marcbodea">@marcbodea</a> for maintaining Sileo!</i>
</p>

## Overview

Sileo is a free Windows dictation app inspired by [Wispr Flow](https://wisprflow.ai/), [Superwhisper](https://superwhisper.com/), and [Monologue](https://www.monologue.to/). It gives you fast AI transcription, context-aware cleanup, and voice-driven text editing without a monthly subscription.

## Quick Start

1. Download the app from above or [click here](https://github.com/sileo-app/sileo/releases/latest/download/Sileo-Setup.exe)
2. Get a free Groq API key from [groq.com](https://groq.com/)
3. Press `F9` to start and stop dictation, and have whatever you say pasted into the current text field
...
- **Context-aware cleanup:** Sileo can read nearby app context so names, terms, and phrases are spelled correctly when you dictate into email, terminals, docs, and other apps.
- **Custom vocabulary:** Add names, jargon, and project-specific words that Sileo should preserve during cleanup.
...
<details>
  ...
  Sileo keeps the default network timeout at 20 seconds, but you can change it in the settings.json file.
</details>
